...
6. The program will display a text box to enter a file name containing BasicML instructions. Once you have typed the name of your file hit the load button.
